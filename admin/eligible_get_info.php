...
if(isset($_POST['company_get_id']))
{
	$company_get_id = $_POST['company_get_id'];
	$sql = "SELECT ts.enrollment_no, full_name, branch, passing_year, present_status from tbl_student_profile ts, tbl_elegible_student te where ts.enrollment_no = te.enrollment_no and company_id = '$company_get_id' ";
